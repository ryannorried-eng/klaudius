...
export const metadata: Metadata = {
  title: 'Contact | Prestige Construction & Remodeling LLC · Waco, TX',
  description: 'Contact Prestige Construction & Remodeling in Waco, TX. Call (254) 981-4152 for a free estimate. Serving Waco, Woodway, Hewitt, and McLennan County. Open 7 days.',
}

const PHONE = '(254) 981-4152'
const ADDRESS = '601 Hatton St, Waco, TX 76704'
const CITY = 'Waco'
const emergency = false

const serviceArea = ['Waco', 'Woodway', 'Hewitt', 'Robinson', 'Bellmead', 'McGregor', 'Lorena']
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <p style={{
            ...
            Call Manny directly or fill out the form below. We&rsquo;ll set up a walk-through at your convenience and give you a detailed, written estimate — no obligation, no upsell, open 7 days a week.
          </p>
        </div>
      </section>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
            <div style={{ background: 'var(--color-accent)', borderRadius: '4px', padding: 'clamp(1.5rem, 3vw, 2rem)' }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.875rem', color: 'var(--color-bg)', opacity: 0.75, lineHeight: 1.5 }}>
                Mon–Fri 7 AM–6 PM · Sat 8 AM–3 PM · Sun 9 AM–5 PM
              </p>
            </div>
            ...
            <div style={{ background: 'var(--color-surface)', border: '1px solid var(--color-border)', borderRadius: '4px', padding: 'clamp(1.5rem, 3vw, 2rem)' }}>
              ...
              {hours.map((h, i) => (
                <div key={i} style={{
                  ...
                  <span style={{ fontFamily: 'var(--font-body)', fontSize: '0.875rem', color: 'var(--color-accent)', fontWeight: 500, whiteSpace: 'nowrap' }}>
                    {h.hours}
                  </span>
                </div>
              ))}
      ...
      <section style={{ padding: 'clamp(3rem, 7vw, 5rem) clamp(1rem, 5vw, 2.5rem)', background: 'var(--color-surface)', borderTop: '1px solid var(--color-border)', textAlign: 'center' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.9375rem', color: 'var(--color-muted)', lineHeight: 1.7, marginBottom: '2rem' }}>
            No obligation, no pressure. Just a straight conversation about your project — open 7 days a week.
          </p>
          <a
            href={`tel:${PHONE}`}
            style={{ display: 'inline-block', background: 'var(--color-accent)', color: 'var(--color-bg)', padding: '0.9375rem 2.25rem', borderRadius: '4px', fontFamily: 'var(--font-body)', fontWeight: 700, textDecoration: 'none', fontSize: '1.0625rem', letterSpacing: '0.01em' }}
          >
            Call {PHONE}
          </a>
          <p style={{ marginTop: '1.25rem', fontFamily: 'var(--font-body)', fontSize: '0.8125rem', color: 'var(--color-muted)' }}>
            Licensed &amp; Insured &middot; {CITY}, TX &middot; Free Estimates &middot; Open 7 Days
          </p>
        </div>
      </section>
    </main>
